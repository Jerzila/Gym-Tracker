    ...
    <>
      <div className="flex h-full min-h-0 flex-col rounded-xl border border-zinc-800 bg-zinc-900/50 p-3 transition hover:border-zinc-700">
        ...
        <button
          ...
          className="tap-feedback mt-2 w-full shrink-0 rounded-lg py-1.5 text-center text-[11px] font-medium text-amber-400/95 transition hover:bg-zinc-800/80 hover:text-amber-300"
        >
          See all ranks
        </button>
      </div>
