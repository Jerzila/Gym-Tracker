...
export default function AccountSettingsPage() {
  return (
    <div className="mx-auto max-w-xl space-y-3 px-4 pb-24 pt-2 sm:px-6">
      <SettingsMenuRow
        href={appHref("/account/edit-profile")}
        title="Profile"
        subtitle="Change username"
      />
      <SettingsMenuRow
        href={appHref("/account/settings/body-metrics")}
        title="Body metrics"
        subtitle="Body weight · Height"
      />
      <SettingsMenuRow
        href={appHref("/account/settings/preferences")}
        title="Preferences"
        subtitle="Units (kg/cm or lb/ft)"
      />
      <SettingsMenuRow
        href={appHref("/account/settings/about")}
        title="About you"
        subtitle="Name · Birthday · Gender · Country"
      />
      <SettingsMenuRow
        href={appHref("/account/settings/security")}
        title="Security"
      ...
      <SettingsMenuRow href={appHref("/account/settings/other")} title="Other" subtitle="Sign out" />
