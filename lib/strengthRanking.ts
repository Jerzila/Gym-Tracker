...
/**
 * Core endurance volume: score = bestHoldSeconds + (points per rep) × bestBodyweightReps (historical bests; see computeStrengthRankingForUser).
 * Thresholds scaled ~8% vs prior bands so core ranks require a bit more volume.
 */
const CORE_VOLUME_STEPS: RankStep[] = [
  ...
  step(318, "Titan", "II"),
  step(302, "Titan", "III"),
  step(288, "Grandmaster", "I"),
  step(274, "Grandmaster", "II"),
  step(259, "Grandmaster", "III"),
  step(248, "Master", "I"),
  step(238, "Master", "II"),
  step(227, "Master", "III"),
  step(216, "Elite", "I"),
  ...
  step(162, "Pro", "III"),
  step(151, "Semi-Pro", "I"),
  step(140, "Semi-Pro", "II"),
  step(130, "Semi-Pro", "III"),
  step(119, "Lifter", "I"),
  step(108, "Lifter", "II"),
  step(97, "Lifter", "III"),
  step(86, "Apprentice", "I"),
  step(76, "Apprentice", "II"),
  step(65, "Apprentice", "III"),
  step(54, "Starter", "I"),
  step(43, "Starter", "II"),
  step(32, "Starter", "III"),
  step(22, "Newbie", "I"),
...
/** Map core volume into overall ratio blend; `min(2.5, s/128)` (same cap as before rank thresholds moved). */
export const CORE_VOLUME_FOR_OVERALL_DIVISOR = 128;

/** Forearm ratio ladder eased vs original tables (~0.93 then ~0.90). */
const FOREARMS_STEPS: RankStep[] = [
  step(2.3, "GOAT", "I"),
  step(2.1, "Titan", "III"),
  step(1.95, "Titan", "II"),
  step(1.81, "Titan", "I"),
  step(1.67, "Grandmaster", "III"),
  step(1.58, "Grandmaster", "II"),
  step(1.48, "Grandmaster", "I"),
  step(1.38, "Master", "III"),
  step(1.29, "Master", "II"),
  step(1.2, "Master", "I"),
  step(1.09, "Elite", "III"),
  step(0.99, "Elite", "II"),
  ...
  step(0.75, "Pro", "II"),
  step(0.69, "Pro", "I"),
  step(0.63, "Semi-Pro", "III"),
  step(0.58, "Semi-Pro", "II"),
  step(0.53, "Semi-Pro", "I"),
  step(0.49, "Lifter", "III"),
  step(0.42, "Lifter", "II"),
  step(0.37, "Lifter", "I"),
  step(0.3, "Apprentice", "III"),
  step(0.25, "Apprentice", "II"),
  step(0.21, "Apprentice", "I"),
  step(0.17, "Starter", "III"),
  step(0.14, "Starter", "II"),
  step(0.1, "Starter", "I"),
  step(0.06, "Newbie", "III"),
  step(0.05, "Newbie", "II"),
  step(0.02, "Newbie", "I"),
];
